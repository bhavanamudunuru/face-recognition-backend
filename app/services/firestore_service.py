...
def register_user(user_id: str, face_image_url: str, name: str = "") -> None:
    """Create or update a user's registration record with their face image URL."""
...
def save_scan_result(user_id: str, image_url: str, status: str, confidence: float = None, message: str = "") -> None:
    """Save a face scan result to the face_scans collection."""
...
def save_duplicate_record(new_user_id: str, existing_user_id: str, image_url: str) -> None:
